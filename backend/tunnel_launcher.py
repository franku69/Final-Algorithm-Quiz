...
def fetch_json(url, timeout=15):
    request = urllib.request.Request(url, headers={'User-Agent': 'PacketQuest-GitHub-Backend/7.2', 'Accept': 'application/json'})
...
def download_cloudflared(directory):
    ...
    request = urllib.request.Request(url, headers={'User-Agent': 'PacketQuest-GitHub-Backend/7.2'})
    count = 0
    try:
...
def main():
    ...
    try:
        ...
        print('\nPACKET QUEST GITHUB BACKEND v7.2 | 40 MCQ | CS111 TOPIC 5: ALGORITHMS\n', flush=True)
