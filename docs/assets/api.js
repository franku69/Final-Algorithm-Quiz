(function () {
  ...
  async function test(value) {
    ...
    if (!response.ok || !data.live || data.bankId !== cfg.bankId || data.questionCount !== cfg.questionCount) throw Error('That server is reachable, but it is not the matching 40-question Topic 5 Algorithms Packet Quest backend.');
    return data;
  }
